...
comandos hardcoded para shared-core, manifests e view-models.

Handoff para outra IA:

```text
frontend/handoff/README.md
frontend/handoff/01-client-orders-deliveries-shared-core.md
frontend/handoff/02-client-orders-screens-render-only.md
frontend/handoff/03-client-landing-manifest-copy.md
frontend/handoff/04-admin-render-only-screen-types.md
frontend/handoff/05-checklists-and-validation.md
```
