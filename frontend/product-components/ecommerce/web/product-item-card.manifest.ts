...
export const productItemCardManifest = {
  ...
  targetPath: "frontend/product-components/ecommerce/web/ProductItemCard.tsx",
  manifestPath: "frontend/product-components/ecommerce/web/product-item-card.manifest.ts",
  owner: "RoyalPrime ecommerce product-components",
  status: "mapped",
  manifestScope: {
    owns: [
      "data contract",
  ...
  designSystemBoundary: {
    futureOwner: "ServiceOS ecommerce product-components",
    rule: "Visual primitives and recipes decide shape, typography, icon style, spacing and button presentation.",
    currentAdapter: "RoyalPrime ProductItemCard composes Foundation primitives and keeps ecommerce state in the consumer flow."
  },
  composition: {
    media: {
      slot: "image",
