...
export function mapAdminPlanDto(dto: AdminPlanDto): AdminPlanView {
  return {
    ...
    deliveryMinBusinessDays: dto.delivery_min_business_days ?? 3,
    deliveryMaxBusinessDays: dto.delivery_max_business_days ?? 8,
    sortOrder: dto.sort_order ?? 0,
...
export function mapAdminPlanFormInput(input: AdminPlanFormInput): AdminPlanCreateDto {
  return {
    ...
    delivery_min_business_days: input.deliveryMinBusinessDays,
    delivery_max_business_days: input.deliveryMaxBusinessDays,
