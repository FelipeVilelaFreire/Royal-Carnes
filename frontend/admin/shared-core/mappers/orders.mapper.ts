...
export function mapAdminOrderDto(dto: AdminOrderDto): OrderBase {
  return {
    ...
    addressLabel: dto.address_label ?? "",
    subscriptionId: dto.subscription_id ?? null,
    subscriptionPlanKey: dto.subscription_plan_key ?? null,
    subscriptionPlanName: dto.subscription_plan_name ?? null,
    subscriptionCycleId: dto.subscription_cycle_id ?? null,
    subscriptionCycleNumber: dto.subscription_cycle_number ?? null,
    subscriptionCycleStatus: dto.subscription_cycle_status ?? null,
    subscriptionCycleStartsAt: dto.subscription_cycle_starts_at ?? null,
    subscriptionCycleEndsAt: dto.subscription_cycle_ends_at ?? null,
    boxCycleId: dto.box_cycle_id ?? null,
    boxCycleKey: dto.box_cycle_key ?? null,
    boxCycleScheduledFor: dto.box_cycle_scheduled_for ?? null,
    boxCycleStatus: dto.box_cycle_status ?? null,
    boxTemplateName: dto.box_template_name ?? null,
    boxOrderCreationPolicy: dto.box_order_creation_policy ?? null,
    boxRecurrenceDay: dto.box_recurrence_day ?? null,
