...
export const adminNavigation: Array<AdminNavigationItem & AppShellNavigationItem> = [
  ...
  },
  {
    ...
    groupOrder: 2,
    iconIntent: "category-management",
  ...
  },
  {
    ...
    groupLabelKey: "navigationGroups.management",
    groupOrder: 2,
    iconIntent: "collection-discovery",
    screenKey: "colecoes",
    routeKey: "colecoes",
    routePath: "/colecoes",
    order: 9,
  ...
  {
    key: "deliveryPromisePolicies",
    labelKey: "navigation.deliveryPromisePolicies",
    groupKey: "management",
    groupLabelKey: "navigationGroups.management",
    groupOrder: 2,
    iconIntent: "delivery",
    screenKey: "deliveryPromisePolicies",
    routeKey: "deliveryPromisePolicies",
    routePath: "/politicas-de-entrega",
    order: 10,
    placements: adminPrimaryPlacements,
  },
  {
