...
e definir uma ordem incremental para mover isso para shared-core, manifests,
...
frontend/client/shared-core/manifests/checkout.manifest.ts
```
...
frontend/client/shared-core/manifests/landing
frontend/client/shared-core/locales/pt-BR.ts
```
...
frontend/client/shared-core/kits/checkout
frontend/client/shared-core/kits/orders
frontend/client/shared-core/manifests/box.manifest.ts
```
...
frontend/admin/shared-core/manifests/pages/dashboard.config.jsx
