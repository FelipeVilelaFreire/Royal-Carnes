...
export const MinhaContaView: React.FC<MinhaContaViewProps> = ({ onNavigate }) => {
  ...
  return (
    ...
    >
      ...
      {/* 2. Conteúdo Mestre da Página "Minha Conta" */}
      <main
        style={{
          flex: 1,
          maxWidth: "1440px",
      ...
      >
        {/* Cabeçalho da Página Minha Conta com Saudação */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: "16px" }}>
          <div>
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "42px", fontWeight: "700", margin: "0 0 6px 0", color: tokens.text }}>
              Minha Conta
            </h1>
            <p style={{ fontSize: "16px", color: tokens.textMuted, margin: 0 }}>
              Olá, {personalData.name.split(" ")[0]}. Gerencie sua experiência e assinaturas no Royal Carnes.
            </p>
          </div>
        ...
        {/* Barra de Abas Horizontais em Card Pílula */}
        <div
          style={{
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                style={{
                  background: isActive ? tokens.copper : "transparent",
