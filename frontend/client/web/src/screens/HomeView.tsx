...
import { primeCutClubIdentity } from "@shared-core/identity";

export const HomeView: React.FC = () => {
  const { palette } = primeCutClubIdentity;
  ...
  return (
    <div style={{ width: "100%", padding: "32px", boxSizing: "border-box" }}>
      ...
      <Text variant="body" style={{ color: palette.textMuted, marginBottom: "24px" }}>
