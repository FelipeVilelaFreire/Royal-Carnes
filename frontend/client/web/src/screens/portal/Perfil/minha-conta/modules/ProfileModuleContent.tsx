...
export function ProfileModuleContent({
  ...
  if (customer.activeTab === "subscription") {
    return <SubscriptionModule currentPlanKey={customer.selectedPlanKey} onChangePlan={customer.actions.openPlansModal} plans={customer.dataSource.plans} strings={strings} viewModel={customer.viewModel} />;
  }
  ...
  if (customer.activeTab === "addresses") return <AddressesModule addresses={customer.dataSource.customer.addresses} strings={strings} />;
