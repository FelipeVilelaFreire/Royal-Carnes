...
export const HeroMarketplaceView: React.FC<HeroMarketplaceViewProps> = ({ onNavigate }) => {
  ...
  // IntersectionObserver para animacao Appear to Scroll (Fade In / Slide Up)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      {/* 2. Hero Section com Imagem de Fundo Full-Bleed */}
      <section
        style={{
          position: "relative",
          minHeight: "88vh",
      ...
      {/* 3. Seção Diferenciais do Clube (#clube) */}
      <section
        id="clube"
        className="appear-on-scroll"
        style={{
      ...
      <section id="assinaturas" className="appear-on-scroll" style={{ padding: "80px 32px", maxWidth: "1440px", width: "100%", margin: "0 auto", boxSizing: "border-box" }}>
        ...
        {/* Grid de 3 Cards de Assinatura (Badge MAIS VENDIDO posicionado perfeitamente no interior) */}
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div>
                <Button variant="accent" size="lg" onClick={() => onNavigate ? onNavigate("/minha-caixa") : (window.location.href = "/minha-caixa")}>
                  Garantir Meu Brinde
                </Button>
              </div>
            </div>
