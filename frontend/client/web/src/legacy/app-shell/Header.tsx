...
export interface PortalHeaderProps {
  activeTab?: "home" | "cortes" | "produtos" | "meus-pedidos" | "minha-caixa" | "hero" | "meu-clube" | "minha-conta" | "portal-home" | "portal-cortes" | "portal-minha-caixa" | "portal-minha-conta";
          ...
          <nav style={{ display: "flex", alignItems: "center", gap: "8px", height: "100%" }} className="hidden md:flex">
            {navItems.map((item) => {
              const isActive = activeTab === item.key ||
                ...
                (activeTab === "meus-pedidos" && item.key === "meus-pedidos") ||
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <button
                ...
                style={{
                  ...
                  borderRadius: "9999px",
                  background: isDark ? "rgba(34, 31, 30, 0.7)" : "rgba(242, 241, 237, 0.76)",
                  border: `1px solid ${tokens.border}`,
                  color: tokens.text,
                  fontFamily: "'Inter', sans-serif",
                  display: "inline-flex",
              ...
              >
                ...
                <span style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "1px", lineHeight: 1 }}>
                  ...
                  <span style={{ fontSize: "10px", color: tokens.textMuted, textTransform: "uppercase", letterSpacing: "0.08em" }}>
