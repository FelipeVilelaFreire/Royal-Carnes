  ...
  return (
    ...
    >
      {tabs.map((tab) => {
        ...
        const isActive = activeTab === tab.key || (activeTab === "home" && tab.key === "portal-home") || (activeTab === "hero" && tab.key === "portal-home") || (activeTab === "cortes" && tab.key === "portal-cortes") || (activeTab === "minha-caixa" && tab.key === "produtos") || (activeTab === "meus-pedidos" && tab.key === "meus-pedidos") || (activeTab === "minha-conta" && tab.key === "minha-conta") || (activeTab === "portal-minha-conta" && tab.key === "minha-conta");
