...
copy de UI para `locales`, manifest ou dados/mock, sem criar regra nova no
shared-core.
...
```text
admin deve receber copy de manifest/admin shared-core
...
locales ou manifest sem criar novas funcionalidades e sem alterar visual.
