# HISTORICO SUBSTITUIDO

Nao usar como instrucao ativa. Versao anterior a consolidacao documental de
2026-09-07. Entrada vigente: AGENTS.md na raiz do RoyalPrime.

---

# Central de Documentacao do RoyalPrime

Bem-vindo a central de documentacao do projeto RoyalPrime.
...
- [Arquitetura e Design System (`docs/architecture/`)](architecture/)
  - `NEXT_STEPS.md`
  - `FRONTEND_TARGET_TREE_ROADMAP.md`
  - `SHARED_CORE_TREE_STANDARD.md`
  - `MANIFEST_DESIGN_SYSTEM_TREE.md`
  - `DESIGN_SYSTEM_V1_TREE.md`
  - `OWNERSHIP_TREE.md`
  - `BACKEND_RULES.md`
...
- [Kits Reutilizaveis (`docs/kits/`)](kits/)
  - `README.md`
  - `auth-users-kit.md`
  - `catalog-kit.md`
...
- [Frontend Docs (`docs/frontend/`)](frontend/)
  - `TREE.md`
  - `RENDER_ONLY_AUDIT.md`
  - `COPY_LOCALE_AUDIT.md`
  - `KIT_FUNCTIONALITY_STRATEGY.md`
- [Frontend Handoff (`docs/handoff/`)](handoff/)
